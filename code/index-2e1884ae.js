 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zr=(e,t)=>t.kind==="method"&&t.descriptor&&!("value"in t.descriptor)?{...t,finisher(r){r.createProperty(t.key,e)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:t.key,initializer(){typeof t.initializer=="function"&&(this[t.key]=t.initializer.call(this))},finisher(r){r.createProperty(t.key,e)}};function le(e){return(t,r)=>r!==void 0?((o,s,i)=>{s.constructor.createProperty(i,o)})(e,t,r):zr(e,t)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Mt;((Mt=window.HTMLSlotElement)===null||Mt===void 0?void 0:Mt.prototype.assignedElements)!=null;const Mr="modulepreload",Br=function(e){return"/"+e},ke={},C=function(t,r,o){if(!r||r.length===0)return t();const s=document.getElementsByTagName("link");return Promise.all(r.map(i=>{if(i=Br(i),i in ke)return;ke[i]=!0;const n=i.endsWith(".css"),c=n?'[rel="stylesheet"]':"";if(!!o)for(let u=s.length-1;u>=0;u--){const d=s[u];if(d.href===i&&(!n||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${c}`))return;const l=document.createElement("link");if(l.rel=n?"stylesheet":Mr,n||(l.as="script",l.crossOrigin=""),l.href=i,document.head.appendChild(l),n)return new Promise((u,d)=>{l.addEventListener("load",u),l.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>t()).catch(i=>{const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i})},de=Symbol.for("app-tools::log::1.x");globalThis[de]={setDebug:Hr,debug:"window"in globalThis?new URL(window.location.href).searchParams.has("app-tools-debug"):!1};function Hr(e){globalThis[de].debug=!!e}function Dr(e,t){globalThis[de].debug&&(console.groupCollapsed(`[app-tools] ${e}`),t&&console.log(t),console.groupEnd())}function Ir(e){return(t,r)=>{Dr(`${e}: ${t}`,r)}}const S=Ir("router");class Vr extends Event{constructor(t){super("route-changed"),this.context=t}}class jr extends EventTarget{context={params:{},query:{},title:"",url:new URL(window.location.href)};constructor(t){super(),this.config=t,this.routes=t.routes.map(r=>({...r,urlPattern:new URLPattern({pathname:r.path,baseURL:window.location.href,search:"*",hash:"*"})})),S("Initialized routes",this.routes),queueMicrotask(()=>{this.navigate(new URL(window.location.href))}),window.addEventListener("popstate",this._onPopState),window.addEventListener("click",this._onAnchorClick)}uninstall(){window.removeEventListener("popstate",this._onPopState),window.removeEventListener("click",this._onAnchorClick)}get url(){return new URL(window.location.href)}get fallback(){return new URL(this.config?.fallback||this.baseUrl.href.substring(window.location.origin.length),this.baseUrl)}get baseUrl(){return new URL("./",document.baseURI)}render(){return S(`Rendering route ${this.context.url.pathname}${this.context.url.search}${this.context.url.hash}`,{context:this.context,route:this.route}),this.route?.render?.(this.context)}_matchRoute(t){for(const r of this.routes){const o=r.urlPattern.exec(t);if(o){const{title:s}=r,i=Object.fromEntries(new URLSearchParams(t.search)),n=o?.pathname?.groups??{};return this.context={url:t,title:typeof s=="function"?s({params:n,query:i,url:t}):s,params:n,query:i},r}}return S(`No route matched for ${t.pathname}${t.search}${t.hash}`,t),null}_notifyUrlChanged(){this.dispatchEvent(new Vr(this.context))}_onPopState=()=>{this.navigate(new URL(window.location.href),{backNav:!0})};_onAnchorClick=t=>{if(t.defaultPrevented||t.button!==0||t.metaKey||t.ctrlKey||t.shiftKey)return;const r=t.composedPath().find(i=>i.tagName==="A");if(!r||!r.href)return;const o=new URL(r.href);if(this.url.href===o.href||o.host!==window.location.host||r.hasAttribute("download")||r.href.includes("mailto:"))return;const s=r.getAttribute("target");s&&s!==""&&s!=="_self"||(t.preventDefault(),this.navigate(o))};_collectPlugins(t){return[...this.config?.plugins??[],...t?.plugins??[]]}async navigate(t,r={}){typeof t=="string"&&(t=new URL(t,this.baseUrl));let o=this._matchRoute(t)||this._matchRoute(this.fallback);S(`Navigating to ${t.pathname}${t.search}${t.hash}`,{context:this.context,route:this.route});let s=this._collectPlugins(o);for(const i of s)try{const n=await i?.shouldNavigate?.(this.context);n&&(await n.condition()||(t=new URL(n.redirect,this.baseUrl),o=this._matchRoute(t)||this._matchRoute(this.fallback),s=this._collectPlugins(o),S("Redirecting",{context:this.context,route:this.route})))}catch(n){throw S(`Plugin "${i.name}" error on shouldNavigate hook`,n),n}if(this.route=o,!this.route)throw new Error(`[ROUTER] No route or fallback matched for url ${t}`);for(const i of s)try{await i?.beforeNavigation?.(this.context)}catch(n){throw S(`Plugin "${i.name}" error on beforeNavigation hook`,n),n}r.backNav||window.history.pushState(null,"",`${t.pathname}${t.search}${t.hash}`),document.title=this.context.title,this._notifyUrlChanged();for(const i of s)try{await i?.afterNavigation?.(this.context)}catch(n){throw S(`Plugin "${i.name}" error on afterNavigation hook`,n),n}}}function O(e){return{name:"lazy",beforeNavigation:()=>{e()}}}globalThis.URLPattern||await C(()=>import("./index-d961e0b8.js"),[]);const Fr="/",Pe=new jr({routes:[{path:_(),title:"Home",render:()=>$`<app-home></app-home>`},{path:_("about"),title:"About",plugins:[O(()=>C(()=>import("./app-about-3b65da93.js"),["code/app-about-3b65da93.js","code/chunk.KRP3ULQL-4d176e08.js"]))],render:()=>$`<app-about></app-about>`},{path:_("كتاب-الطهارة"),title:"كتاب الطهارة",plugins:[O(()=>C(()=>import("./kitab-al-tahara-164049dd.js"),["code/kitab-al-tahara-164049dd.js","code/chunk.KRP3ULQL-4d176e08.js"]))],render:()=>$`<kitab-al-tahara></kitab-al-tahara>`},{path:_("كتاب-الطهارة/باب-الوضوء"),title:"كتاب الطهارة باب الوضوء",plugins:[O(()=>C(()=>import("./bab-al-wodo-c3dc02f1.js"),["code/bab-al-wodo-c3dc02f1.js","code/chunk.KRP3ULQL-4d176e08.js"]))],render:()=>$`<kitab-al-tahara-bab-al-wodo></kitab-al-tahara-bab-al-wodo>`},{path:_(".كتاب-الطهارة/باب-الوضوء/تَبْلُغُ الحِلْيَةُ مِنَ المُؤْمِنِ، حَيْثُ يَبْلُغُ الوَضُوءُ"),title:".تَبْلُغُ الحِلْيَةُ مِنَ المُؤْمِنِ، حَيْثُ يَبْلُغُ الوَضُوءُ",plugins:[O(()=>C(()=>import("./bab-al-wodo-1-3ad93066.js"),["code/bab-al-wodo-1-3ad93066.js","code/chunk.KRP3ULQL-4d176e08.js"]))],render:()=>$`<kitab-al-tahara-bab-al-wodo-1></kitab-al-tahara-bab-al-wodo-1>`},{path:_("كتاب-الصلاة"),title:"كتاب الصلاة",plugins:[O(()=>C(()=>import("./kitab-al-salah-26123af0.js"),["code/kitab-al-salah-26123af0.js","code/chunk.KRP3ULQL-4d176e08.js"]))],render:()=>$`<kitab-al-salah></kitab-al-salah>`},{path:_("كتاب-الصوم"),title:"كتاب الصوم",plugins:[O(()=>C(()=>import("./kitab-al-sawm-e0e092d9.js"),["code/kitab-al-sawm-e0e092d9.js","code/chunk.KRP3ULQL-4d176e08.js"]))],render:()=>$`<kitab-al-sawm></kitab-al-sawm>`},{path:_("كتاب-الأخلاق"),title:"كتاب الأخلاق",plugins:[O(()=>C(()=>import("./kitab-al-akhlaq-4d550888.js"),["code/kitab-al-akhlaq-4d550888.js","code/chunk.KRP3ULQL-4d176e08.js"]))],render:()=>$`<kitab-al-akhlaq></kitab-al-akhlaq>`}]});function _(e){var t=Fr;return e&&(t=t+e),t}var mt=window,ce=mt.ShadowRoot&&(mt.ShadyCSS===void 0||mt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,he=Symbol(),Le=new WeakMap,lr=class{constructor(t,r,o){if(this._$cssResult$=!0,o!==he)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o;const r=this.t;if(ce&&t===void 0){const o=r!==void 0&&r.length===1;o&&(t=Le.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),o&&Le.set(r,t))}return t}toString(){return this.cssText}},qr=e=>new lr(typeof e=="string"?e:e+"",void 0,he),M=(e,...t)=>{const r=e.length===1?e[0]:t.reduce((o,s,i)=>o+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+e[i+1],e[0]);return new lr(r,e,he)},Wr=(e,t)=>{ce?e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet):t.forEach(r=>{const o=document.createElement("style"),s=mt.litNonce;s!==void 0&&o.setAttribute("nonce",s),o.textContent=r.cssText,e.appendChild(o)})},Ue=ce?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(const o of t.cssRules)r+=o.cssText;return qr(r)})(e):e,Bt,$t=window,Oe=$t.trustedTypes,Kr=Oe?Oe.emptyScript:"",Re=$t.reactiveElementPolyfillSupport,Gt={toAttribute(e,t){switch(t){case Boolean:e=e?Kr:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=e!==null;break;case Number:r=e===null?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch{r=null}}return r}},dr=(e,t)=>t!==e&&(t==t||e==e),Ht={attribute:!0,type:String,converter:Gt,reflect:!1,hasChanged:dr},D=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,r)=>{const o=this._$Ep(r,t);o!==void 0&&(this._$Ev.set(o,r),e.push(o))}),e}static createProperty(e,t=Ht){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const r=typeof e=="symbol"?Symbol():"__"+e,o=this.getPropertyDescriptor(e,r,t);o!==void 0&&Object.defineProperty(this.prototype,e,o)}}static getPropertyDescriptor(e,t,r){return{get(){return this[t]},set(o){const s=this[e];this[t]=o,this.requestUpdate(e,s,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Ht}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,r=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const o of r)this.createProperty(o,t[o])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const o of r)t.unshift(Ue(o))}else e!==void 0&&t.push(Ue(e));return t}static _$Ep(e,t){const r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}u(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,r;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((r=e.hostConnected)===null||r===void 0||r.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Wr(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var r;return(r=t.hostConnected)===null||r===void 0?void 0:r.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var r;return(r=t.hostDisconnected)===null||r===void 0?void 0:r.call(t)})}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$EO(e,t,r=Ht){var o;const s=this.constructor._$Ep(e,r);if(s!==void 0&&r.reflect===!0){const i=(((o=r.converter)===null||o===void 0?void 0:o.toAttribute)!==void 0?r.converter:Gt).toAttribute(t,r.type);this._$El=e,i==null?this.removeAttribute(s):this.setAttribute(s,i),this._$El=null}}_$AK(e,t){var r;const o=this.constructor,s=o._$Ev.get(e);if(s!==void 0&&this._$El!==s){const i=o.getPropertyOptions(s),n=typeof i.converter=="function"?{fromAttribute:i.converter}:((r=i.converter)===null||r===void 0?void 0:r.fromAttribute)!==void 0?i.converter:Gt;this._$El=s,this[s]=n.fromAttribute(t,i.type),this._$El=null}}requestUpdate(e,t,r){let o=!0;e!==void 0&&(((r=r||this.constructor.getPropertyOptions(e)).hasChanged||dr)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),r.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,r))):o=!1),!this.isUpdatePending&&o&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((o,s)=>this[s]=o),this._$Ei=void 0);let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(e=this._$ES)===null||e===void 0||e.forEach(o=>{var s;return(s=o.hostUpdate)===null||s===void 0?void 0:s.call(o)}),this.update(r)):this._$Ek()}catch(o){throw t=!1,this._$Ek(),o}t&&this._$AE(r)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(r=>{var o;return(o=r.hostUpdated)===null||o===void 0?void 0:o.call(r)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,r)=>this._$EO(r,this[r],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};D.finalized=!0,D.elementProperties=new Map,D.elementStyles=[],D.shadowRootOptions={mode:"open"},Re?.({ReactiveElement:D}),((Bt=$t.reactiveElementVersions)!==null&&Bt!==void 0?Bt:$t.reactiveElementVersions=[]).push("1.6.1");var Dt,wt=window,Z=wt.trustedTypes,Te=Z?Z.createPolicy("lit-html",{createHTML:e=>e}):void 0,P=`lit$${(Math.random()+"").slice(9)}$`,cr="?"+P,Zr=`<${cr}>`,J=document,ct=(e="")=>J.createComment(e),ht=e=>e===null||typeof e!="object"&&typeof e!="function",hr=Array.isArray,Jr=e=>hr(e)||typeof e?.[Symbol.iterator]=="function",rt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ne=/-->/g,ze=/>/g,R=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Me=/'/g,Be=/"/g,ur=/^(?:script|style|textarea|title)$/i,Yr=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),pt=Yr(1),z=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),He=new WeakMap,j=J.createTreeWalker(J,129,null,!1),Gr=(e,t)=>{const r=e.length-1,o=[];let s,i=t===2?"<svg>":"",n=rt;for(let a=0;a<r;a++){const l=e[a];let u,d,p=-1,m=0;for(;m<l.length&&(n.lastIndex=m,d=n.exec(l),d!==null);)m=n.lastIndex,n===rt?d[1]==="!--"?n=Ne:d[1]!==void 0?n=ze:d[2]!==void 0?(ur.test(d[2])&&(s=RegExp("</"+d[2],"g")),n=R):d[3]!==void 0&&(n=R):n===R?d[0]===">"?(n=s??rt,p=-1):d[1]===void 0?p=-2:(p=n.lastIndex-d[2].length,u=d[1],n=d[3]===void 0?R:d[3]==='"'?Be:Me):n===Be||n===Me?n=R:n===Ne||n===ze?n=rt:(n=R,s=void 0);const y=n===R&&e[a+1].startsWith("/>")?" ":"";i+=n===rt?l+Zr:p>=0?(o.push(u),l.slice(0,p)+"$lit$"+l.slice(p)+P+y):l+P+(p===-2?(o.push(void 0),a):y)}const c=i+(e[r]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Te!==void 0?Te.createHTML(c):c,o]},At=class{constructor({strings:e,_$litType$:t},r){let o;this.parts=[];let s=0,i=0;const n=e.length-1,c=this.parts,[a,l]=Gr(e,t);if(this.el=At.createElement(a,r),j.currentNode=this.el.content,t===2){const u=this.el.content,d=u.firstChild;d.remove(),u.append(...d.childNodes)}for(;(o=j.nextNode())!==null&&c.length<n;){if(o.nodeType===1){if(o.hasAttributes()){const u=[];for(const d of o.getAttributeNames())if(d.endsWith("$lit$")||d.startsWith(P)){const p=l[i++];if(u.push(d),p!==void 0){const m=o.getAttribute(p.toLowerCase()+"$lit$").split(P),y=/([.?@])?(.*)/.exec(p);c.push({type:1,index:s,name:y[2],strings:m,ctor:y[1]==="."?Qr:y[1]==="?"?eo:y[1]==="@"?ro:kt})}else c.push({type:6,index:s})}for(const d of u)o.removeAttribute(d)}if(ur.test(o.tagName)){const u=o.textContent.split(P),d=u.length-1;if(d>0){o.textContent=Z?Z.emptyScript:"";for(let p=0;p<d;p++)o.append(u[p],ct()),j.nextNode(),c.push({type:2,index:++s});o.append(u[d],ct())}}}else if(o.nodeType===8)if(o.data===cr)c.push({type:2,index:s});else{let u=-1;for(;(u=o.data.indexOf(P,u+1))!==-1;)c.push({type:7,index:s}),u+=P.length-1}s++}}static createElement(e,t){const r=J.createElement("template");return r.innerHTML=e,r}};function Y(e,t,r=e,o){var s,i,n,c;if(t===z)return t;let a=o!==void 0?(s=r._$Co)===null||s===void 0?void 0:s[o]:r._$Cl;const l=ht(t)?void 0:t._$litDirective$;return a?.constructor!==l&&((i=a?._$AO)===null||i===void 0||i.call(a,!1),l===void 0?a=void 0:(a=new l(e),a._$AT(e,r,o)),o!==void 0?((n=(c=r)._$Co)!==null&&n!==void 0?n:c._$Co=[])[o]=a:r._$Cl=a),a!==void 0&&(t=Y(e,a._$AS(e,t.values),a,o)),t}var Xr=class{constructor(e,t){this.u=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(e){var t;const{el:{content:r},parts:o}=this._$AD,s=((t=e?.creationScope)!==null&&t!==void 0?t:J).importNode(r,!0);j.currentNode=s;let i=j.nextNode(),n=0,c=0,a=o[0];for(;a!==void 0;){if(n===a.index){let l;a.type===2?l=new Ct(i,i.nextSibling,this,e):a.type===1?l=new a.ctor(i,a.name,a.strings,this,e):a.type===6&&(l=new oo(i,this,e)),this.u.push(l),a=o[++c]}n!==a?.index&&(i=j.nextNode(),n++)}return s}p(e){let t=0;for(const r of this.u)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}},Ct=class{constructor(e,t,r,o){var s;this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=o,this._$Cm=(s=o?.isConnected)===null||s===void 0||s}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cm}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Y(this,e,t),ht(e)?e===f||e==null||e===""?(this._$AH!==f&&this._$AR(),this._$AH=f):e!==this._$AH&&e!==z&&this.g(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Jr(e)?this.k(e):this.g(e)}O(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}g(e){this._$AH!==f&&ht(this._$AH)?this._$AA.nextSibling.data=e:this.T(J.createTextNode(e)),this._$AH=e}$(e){var t;const{values:r,_$litType$:o}=e,s=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=At.createElement(o.h,this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===s)this._$AH.p(r);else{const i=new Xr(s,this),n=i.v(this.options);i.p(r),this.T(n),this._$AH=i}}_$AC(e){let t=He.get(e.strings);return t===void 0&&He.set(e.strings,t=new At(e)),t}k(e){hr(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let r,o=0;for(const s of e)o===t.length?t.push(r=new Ct(this.O(ct()),this.O(ct()),this,this.options)):r=t[o],r._$AI(s),o++;o<t.length&&(this._$AR(r&&r._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var r;for((r=this._$AP)===null||r===void 0||r.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cm=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},kt=class{constructor(e,t,r,o,s){this.type=1,this._$AH=f,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=f}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,r,o){const s=this.strings;let i=!1;if(s===void 0)e=Y(this,e,t,0),i=!ht(e)||e!==this._$AH&&e!==z,i&&(this._$AH=e);else{const n=e;let c,a;for(e=s[0],c=0;c<s.length-1;c++)a=Y(this,n[r+c],t,c),a===z&&(a=this._$AH[c]),i||(i=!ht(a)||a!==this._$AH[c]),a===f?e=f:e!==f&&(e+=(a??"")+s[c+1]),this._$AH[c]=a}i&&!o&&this.j(e)}j(e){e===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Qr=class extends kt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===f?void 0:e}},to=Z?Z.emptyScript:"",eo=class extends kt{constructor(){super(...arguments),this.type=4}j(e){e&&e!==f?this.element.setAttribute(this.name,to):this.element.removeAttribute(this.name)}},ro=class extends kt{constructor(e,t,r,o,s){super(e,t,r,o,s),this.type=5}_$AI(e,t=this){var r;if((e=(r=Y(this,e,t,0))!==null&&r!==void 0?r:f)===z)return;const o=this._$AH,s=e===f&&o!==f||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,i=e!==f&&(o===f||s);s&&this.element.removeEventListener(this.name,this,o),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,r;typeof this._$AH=="function"?this._$AH.call((r=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&r!==void 0?r:this.element,e):this._$AH.handleEvent(e)}},oo=class{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){Y(this,e)}},De=wt.litHtmlPolyfillSupport;De?.(At,Ct),((Dt=wt.litHtmlVersions)!==null&&Dt!==void 0?Dt:wt.litHtmlVersions=[]).push("2.6.1");var so=(e,t,r)=>{var o,s;const i=(o=r?.renderBefore)!==null&&o!==void 0?o:t;let n=i._$litPart$;if(n===void 0){const c=(s=r?.renderBefore)!==null&&s!==void 0?s:null;i._$litPart$=n=new Ct(t.insertBefore(ct(),c),c,void 0,r??{})}return n._$AI(e),n},It,Vt,at=class extends D{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const r=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=r.firstChild),r}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=so(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return z}};at.finalized=!0,at._$litElement$=!0,(It=globalThis.litElementHydrateSupport)===null||It===void 0||It.call(globalThis,{LitElement:at});var Ie=globalThis.litElementPolyfillSupport;Ie?.({LitElement:at});((Vt=globalThis.litElementVersions)!==null&&Vt!==void 0?Vt:globalThis.litElementVersions=[]).push("3.2.0");/*! Bundled license information:
...
lit-html/directives/class-map.js:
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   *)
*/var vr=Object.defineProperty,co=Object.defineProperties,ho=Object.getOwnPropertyDescriptor,uo=Object.getOwnPropertyDescriptors,Ve=Object.getOwnPropertySymbols,po=Object.prototype.hasOwnProperty,vo=Object.prototype.propertyIsEnumerable,je=(e,t,r)=>t in e?vr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,E=(e,t)=>{for(var r in t||(t={}))po.call(t,r)&&je(e,r,t[r]);if(Ve)for(var r of Ve(t))vo.call(t,r)&&je(e,r,t[r]);return e},B=(e,t)=>co(e,uo(t)),h=(e,t,r,o)=>{for(var s=o>1?void 0:o?ho(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&vr(t,r,s),s},Q=e=>t=>typeof t=="function"?((r,o)=>(customElements.define(r,o),o))(e,t):((r,o)=>{const{kind:s,elements:i}=o;return{kind:s,elements:i,finisher(n){customElements.define(r,n)}}})(e,t),bo=(e,t)=>t.kind==="method"&&t.descriptor&&!("value"in t.descriptor)?B(E({},t),{finisher(r){r.createProperty(t.key,e)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:t.key,initializer(){typeof t.initializer=="function"&&(this[t.key]=t.initializer.call(this))},finisher(r){r.createProperty(t.key,e)}};function v(e){return(t,r)=>r!==void 0?((o,s,i)=>{s.constructor.createProperty(i,o)})(e,t,r):bo(e,t)}function Pt(e){return v(B(E({},e),{state:!0}))}var fo=({finisher:e,descriptor:t})=>(r,o)=>{var s;if(o===void 0){const i=(s=r.originalKey)!==null&&s!==void 0?s:r.key,n=t!=null?{kind:"method",placement:"prototype",key:i,descriptor:t(r.key)}:B(E({},r),{key:i});return e!=null&&(n.finisher=function(c){e(c,i)}),n}{const i=r.constructor;t!==void 0&&Object.defineProperty(r,o,t(o)),e?.(i,o)}};function tt(e,t){return fo({descriptor:r=>{const o={get(){var s,i;return(i=(s=this.renderRoot)===null||s===void 0?void 0:s.querySelector(e))!==null&&i!==void 0?i:null},enumerable:!0,configurable:!0};if(t){const s=typeof r=="symbol"?Symbol():"__"+r;o.get=function(){var i,n;return this[s]===void 0&&(this[s]=(n=(i=this.renderRoot)===null||i===void 0?void 0:i.querySelector(e))!==null&&n!==void 0?n:null),this[s]}}return o}})}var jt;((jt=window.HTMLSlotElement)===null||jt===void 0?void 0:jt.prototype.assignedElements)!=null;var L=class extends at{emit(e,t){const r=new CustomEvent(e,E({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(r),r}};h([v()],L.prototype,"dir",2);h([v()],L.prototype,"lang",2);/*! Bundled license information:
...
@lit/reactive-element/decorators/query-assigned-nodes.js:
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   *)
*/var Xt=class extends L{constructor(){super(...arguments),this.hasSlotController=new pr(this,"footer","header","image")}render(){return pt`
      <div
        part="base"
...
lit-html/static.js:
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   *)
*/var x=e=>e??f;/*! Bundled license information:
...
`,te=class extends L{constructor(){super(...arguments),this.localize=new ve(this)}render(){return pt`
  ...
  `},Po={name:"system",resolver:e=>e in Ke?`data:image/svg+xml,${encodeURIComponent(Ke[e])}`:""},Lo=Po,Uo=[ko,Lo],re=[];function Oo(e){re.push(e)}function Ro(e){re=re.filter(t=>t!==e)}function Ze(e){return Uo.find(t=>t.name===e)}var To=M`
  ${X}
...
`,it=Symbol(),ft=Symbol(),Wt,Kt=new Map,w=class extends L{constructor(){super(...arguments),this.svg=null,this.label="",this.library="default"}static async resolveIcon(e){var t;let r;try{if(r=await fetch(e,{mode:"cors"}),!r.ok)return r.status===410?it:ft}catch{return ft}try{const o=document.createElement("div");o.innerHTML=await r.text();const s=o.firstElementChild;if(((t=s?.tagName)==null?void 0:t.toLowerCase())!=="svg")return it;Wt||(Wt=new DOMParser);const n=Wt.parseFromString(s.outerHTML,"text/html").body.querySelector("svg");return n?(n.part.add("svg"),document.adoptNode(n)):it}catch{return it}}connectedCallback(){super.connectedCallback(),Oo(this)}firstUpdated(){this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Ro(this)}getUrl(){const e=Ze(this.library);return this.name&&e?e.resolver(this.name):this.src}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const t=Ze(this.library),r=this.getUrl();if(!r){this.svg=null;return}let o=Kt.get(r);o||(o=w.resolveIcon(r),Kt.set(r,o));const s=await o;if(s===ft&&Kt.delete(r),r===this.getUrl())switch(s){case ft:case it:this.svg=null,this.emit("sl-error");break;default:this.svg=s.cloneNode(!0),(e=t?.mutator)==null||e.call(t,this.svg),this.emit("sl-load")}}render(){return this.svg}};w.styles=To;h([Pt()],w.prototype,"svg",2);h([v({reflect:!0})],w.prototype,"name",2);h([v()],w.prototype,"src",2);h([v()],w.prototype,"label",2);h([v({reflect:!0})],w.prototype,"library",2);h([Lt("label")],w.prototype,"handleLabelChange",1);h([Lt(["name","src","library"])],w.prototype,"setIcon",1);w=h([Q("sl-icon")],w);var No=M`
  ${X}
...
`,G=class extends L{constructor(){super(...arguments),this.disableRole=!1,this.label=""}handleFocus(e){const t=nt(e.target);t?.classList.add("sl-button-group__button--focus")}handleBlur(e){const t=nt(e.target);t?.classList.remove("sl-button-group__button--focus")}handleMouseOver(e){const t=nt(e.target);t?.classList.add("sl-button-group__button--hover")}handleMouseOut(e){const t=nt(e.target);t?.classList.remove("sl-button-group__button--hover")}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(t=>{const r=e.indexOf(t),o=nt(t);o!==null&&(o.classList.add("sl-button-group__button"),o.classList.toggle("sl-button-group__button--first",r===0),o.classList.toggle("sl-button-group__button--inner",r>0&&r<e.length-1),o.classList.toggle("sl-button-group__button--last",r===e.length-1),o.classList.toggle("sl-button-group__button--radio",o.tagName.toLowerCase()==="sl-radio-button"))})}render(){return pt`
      ...
      ></slot>
    `}};G.styles=Ho;h([tt("slot")],G.prototype,"defaultSlot",2);h([Pt()],G.prototype,"disableRole",2);h([v()],G.prototype,"label",2);G=h([Q("sl-button-group")],G);function nt(e){var t;const r="sl-button, sl-radio-button";return(t=e.closest(r))!=null?t:e.querySelector(r)}const Do=xt`
...
`;var Io=Object.defineProperty,Vo=Object.getOwnPropertyDescriptor,$r=(e,t,r,o)=>{for(var s=o>1?void 0:o?Vo(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&Io(t,r,s),s};let Et=class extends N{constructor(){super(...arguments),this.message="Welcome!"}render(){return $`
      ...
      <sl-button size="large" href="${_("كتاب-الصوم")}">  كتاب الصوم  </sl-button>

      <sl-button size="large" href="${_("كتاب-الأخلاق")}">  كتاب الأخلاق  </sl-button>


      <sl-button size="large" href="${_("كتاب-الطهارة")}">كتاب الطهارة   </sl-button>

      <sl-button  size="large" href="${_("كتاب-الصلاة")}">  كتاب الصلاة  </sl-button>


<sl-button size="large"> هلا عمار شخبار شعلوم</sl-button>

      </main>
    `}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"PWABuilder pwa-starter",text:"Check out the PWABuilder pwa-starter!",url:"https://github.com/pwa-builder/pwa-starter"})}};Et.styles=[Do,xt`
  ...
  `];$r([le()],Et.prototype,"message",2);Et=$r([ae("app-home")],Et);var jo=Object.defineProperty,Fo=Object.getOwnPropertyDescriptor,be=(e,t,r,o)=>{for(var s=o>1?void 0:o?Fo(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&jo(t,r,s),s};let ut=class extends N{constructor(){super(...arguments),this.title="كتاب الاحاديث",this.enableBack=!1}render(){return $`
      <header>
        ...
        <div id="back-button-block">
          ${this.enableBack?$`<sl-button href="${_()}">
            Back
          </sl-button>`:null}
  ...
  `;oe=Ko([ae("app-index")],oe);export{pr as H,ve as L,L as S,h as _,Do as a,M as b,X as c,tt as d,ae as e,v as f,Q as g,yr as h,xt as i,Ye as j,Xe as k,Qe as l,Ge as m,x as n,ue as o,Fe as p,qt as q,_ as r,N as s,Pt as t,Lt as w,$ as x,pt as y};
//# sourceMappingURL=index-2e1884ae.js.map
