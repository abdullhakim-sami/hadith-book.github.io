...
`;var Io=Object.defineProperty,Vo=Object.getOwnPropertyDescriptor,$r=(e,t,r,o)=>{for(var s=o>1?void 0:o?Vo(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&Io(t,r,s),s};let Et=class extends N{constructor(){super(...arguments),this.message="Welcome!"}render(){return $`
      ...
      <main>
        <sl-button size="large" href="${_("كتاب-الصوم")}">
          كتاب الصوم
        </sl-button>

        <sl-button size="large" href="${_("كتاب-الأخلاق")}">
          كتاب الأخلاق
        </sl-button>

        <sl-button size="large" href="${_("كتاب-الطهارة")}"
          >كتاب الطهارة
        </sl-button>

        <sl-button size="large" href="${_("كتاب-الصلاة")}">
          كتاب الصلاة
        </sl-button>
  ...
  `;oe=Ko([ae("app-index")],oe);export{pr as H,ve as L,L as S,h as _,Do as a,z as b,X as c,tt as d,ae as e,v as f,Q as g,yr as h,xt as i,Ye as j,Xe as k,x as l,Qe as m,Ge as n,ue as o,Fe as p,qt as q,_ as r,N as s,Pt as t,Lt as w,$ as x,pt as y};
//# sourceMappingURL=index-a053c9d9.js.map
