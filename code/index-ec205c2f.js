...
`,te=class extends L{constructor(){super(...arguments),this.localize=new ve(this)}render(){return pt`
  ...
  `},Po={name:"system",resolver:e=>e in Ke?`data:image/svg+xml,${encodeURIComponent(Ke[e])}`:""},Lo=Po,Uo=[ko,Lo],re=[];function Oo(e){re.push(e)}function Ro(e){re=re.filter(t=>t!==e)}function Ze(e){return Uo.find(t=>t.name===e)}var To=z`
  ${X}
...
`;var Io=Object.defineProperty,Vo=Object.getOwnPropertyDescriptor,$r=(e,t,r,o)=>{for(var s=o>1?void 0:o?Vo(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&Io(t,r,s),s};let Et=class extends N{constructor(){super(...arguments),this.message="Welcome!"}render(){return $`
  ...
  `;oe=Ko([ae("app-index")],oe);export{pr as H,ve as L,L as S,h as _,Do as a,z as b,X as c,tt as d,ae as e,v as f,Q as g,yr as h,xt as i,Ye as j,Xe as k,Qe as l,Ge as m,x as n,ue as o,Fe as p,qt as q,_ as r,N as s,Pt as t,Lt as w,$ as x,pt as y};
//# sourceMappingURL=index-ec205c2f.js.map
